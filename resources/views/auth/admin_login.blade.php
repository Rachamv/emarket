...
<head>
  <meta charset="utf-8">
    ...
    <title>World Bonus Market Admin - Log in </title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<div class="content-top-agile p-10">
		...
		<p class="text-white-50">Sign in to manage your account</p>							
	</div>
 ...
 <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
		...
		<div class="text-center">
			<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('admin.profile.edit') }}"href="auth_register.html" class="text-info ml-5">Sign Up</a></p>
		</div>
						</div>
					</div>
				</div>
